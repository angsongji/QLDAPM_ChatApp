...
const NotFoundPage = () => {
  return (
    <div className="w-full h-screen flex items-center justify-center">
      <div className="btn btn-sm md:btn-base lg:btn-lg btn-ghost w-fit flex gap-1 items-center !px-0 hover:bg-transparent border-0 absolute top-5 left-5 ">
      ...
      <div className="flex flex-col items-center gap-5 p-5">
        ...
        <div className="text-center flex flex-col gap-2">
          ...
          <p>
            It might have been deleted, renamed, or... abducted by aliens 👽....
          </p>
          <Link to={PATH.HOME} className="underline text-sm font-extrabold">
